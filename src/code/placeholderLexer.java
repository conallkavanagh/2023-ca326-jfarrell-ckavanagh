...
public class placeholderLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T", "U", "V", "W", "X", "Y", "Z", "DATATYPE", "NUMTYPE", "STRTYPE", 
			"BOOLTYPE", "STRING", "ESC", "NUMBER", "BOOL", "IF", "END", "ELSE", "OP", 
			"BOOLOP", "PLUS", "MINUS", "MULT", "DIV", "EQUAL", "ASSIGN", "NOTEQUAL", 
			"LESSTHAN", "GREATERTHAN", "LESSTHANEQ", "GREATERTHANEQ", "SEMICOLON", 
			"LCURL", "RCURL", "COMMENT", "ID", "WS"
		};
	}
